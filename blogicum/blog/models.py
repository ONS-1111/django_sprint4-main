"""Модели блога: локации, категории, посты и комментарии."""
...
class Category(PublishedModel, BaseTitle):
    """Категория постов (со своим слагом и описанием)."""
...
class Post(PublishedModel, BaseTitle):
    """Публикация автора с опциональным изображением."""
...
class Comment(models.Model):
    """Комментарий к публикации, сортируется по возрастанию даты."""
